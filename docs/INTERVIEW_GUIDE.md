...
- **Relevant File**: [`backend/app/main.py`](../backend/app/main.py), [`ARCHITECTURE.md`](../ARCHITECTURE.md).
...
- **Relevant File**: [`backend/app/api/deps.py`](../backend/app/api/deps.py), [`backend/app/tests/test_tenant_isolation.py`](../backend/app/tests/test_tenant_isolation.py).
...
- **Relevant File**: [`backend/app/ai/service.py`](../backend/app/ai/service.py), [`backend/app/ai/validator.py`](../backend/app/ai/validator.py).
...
- **Relevant File**: [`backend/app/api/v1/endpoints/ai.py`](../backend/app/api/v1/endpoints/ai.py), [`backend/app/models/ai_action.py`](../backend/app/models/ai_action.py).
...
- **Relevant File**: [backend/app/models/knowledge_chunk.py](backend/app/models/knowledge_chunk.py), [docker-compose.yml](docker-compose.yml).
...
- **Relevant File**: [backend/app/ai/validator.py](backend/app/ai/validator.py), [backend/app/tests/test_rag.py](backend/app/tests/test_rag.py).
