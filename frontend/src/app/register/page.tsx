...
import { Bot, Lock, Mail, User, Building2, ArrowRight } from "lucide-react"
    ...
    <div className="min-h-screen bg-[#0b0f17] flex flex-col justify-center items-center px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold tracking-tight text-white">Create your OpsPilot Account</h1>
          <p className="text-sm text-slate-400 mt-1">Set up multi-tenant AI customer operations for your business</p>
        </div>
        ...
        <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-8 backdrop-blur-xl shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-300 mb-1.5">Business / Organization Name</label>
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Demo Learning Center"
                  className="w-full bg-slate-950 border border-slate-800 rounded-lg pl-10 pr-4 py-2.5 text-sm text-slate-100 placeholder-slate-500 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-colors"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="sarah@demolearning.com"
                  className="w-full bg-slate-950 border border-slate-800 rounded-lg pl-10 pr-4 py-2.5 text-sm text-slate-100 placeholder-slate-500 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-colors"
                />
              </div>
            </div>
